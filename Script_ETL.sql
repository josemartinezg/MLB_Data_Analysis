Create Table atbats_ODS 
as (select * from atbats);

Create Table games_ODS 
as (select * from games);

Create table pitches_ODS
 as (select * from pitches);

Create Table player_name_ODS 
as (select * from player_name);

Create Table teams_ODS 
